...
LOBJS = src/version.o \
	src/core.o src/common.o src/lib_proxando.o \
...
LDSO_PATHNAME = lib_proxando.$(LDSO_SUFFIX)

SHARED_LIBS = $(LDSO_PATHNAME)
ALL_LIBS = $(SHARED_LIBS)
PXCHAINS = proxando
PXCHAINS_D = proxando-daemon
ALL_TOOLS = $(PXCHAINS) $(PXCHAINS_D)
ALL_CONFIGS = ./proxychains.conf
ZSH_COMPLETION = completions/zsh/_proxando
